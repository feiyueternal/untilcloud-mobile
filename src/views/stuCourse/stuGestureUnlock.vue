<template>
   <div class="stuGestureUnlock">
     ...
     <!-- <div class='incorrectTip'><span v-show="tips">前后格式不一致，请重新绘制</span></div> -->
    </div>
</template>

<script>
export default {
    name: "stuGestureUnlock",
    data() {
        return {
            list: [
    ...
    methods: {
        getCreatePassword() {
            this.createPassword = this.$store.state.createPassword;
        },
         // 手指点下
       start (e) {
